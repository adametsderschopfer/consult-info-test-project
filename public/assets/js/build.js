...
(function () {
  var openMenuBtn = document.querySelector("#menu-btn-open");
  var closeMenuBtn = document.querySelector("#menu-btn-close");
  var menu = document.querySelector("#menu");

  function menuBtnToggleClickHandler() {
    ...
    }, closeDuration);else menu.classList.add("active");
    var animations = {
      open: [{
        height: "0"
      }, {
  ...
  openMenuBtn.addEventListener("click", function () {
    return menuBtnToggleClickHandler();
  });
  closeMenuBtn.addEventListener("click", function () {
    return menuBtnToggleClickHandler(true);
  });
})();
"use strict";
...
function loadPreviewSlickSlider() {
  var btnComponent = function btnComponent(txt, pos) {
    return "<button class='slick-prev preview__arrow preview__arrow-".concat(pos, "'>").concat(txt, "</button>");
  };

  var slickSliderConfig = {
    dots: true,
    speed: 1000,
    infinite: true,
    autoplay: true,
